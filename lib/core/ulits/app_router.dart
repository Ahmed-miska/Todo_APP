...
static final kSplashViewBody5 = '/SplashViewBody5';
 static final router= GoRouter(
    ...
    routes: [
      ...
      GoRoute(path: kSplashViewBody2,builder: (context, state) => SplashViewBody2(),),
      GoRoute(path: kSplashViewBody3,builder: (context, state) => SplashViewBody3(),),
      GoRoute(path: kSplashViewBody4,builder: (context, state) => SplashViewBody4(),),
      GoRoute(path: kSplashViewBody5,builder: (context, state) => SplashViewBody5(),),
